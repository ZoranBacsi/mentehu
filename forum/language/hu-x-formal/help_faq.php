...
*
* @package language
* @version $Id: help_faq.php 240 2013-08-07 20:53:00Z marcee $
...
$help = array(
	...
	array(
		...
		1 => 'Ennek számos oka lehet. Először is ellenőrizze, hogy jól adta-e meg a felhasználónevét és a jelszavát. Ha igen, lépjen kapcsolatba a fórum adminisztrátorával, hogy meggyőződjön róla, nem lett kitiltva. Az is lehetséges, hogy a weboldal üzemeltetőjének oldalán lépett fel valamilyen konfigurációs hiba, melyet javítaniuk kéne.' //? talán átírhatnánk az értelmét...
	),
	array(
	...
	array(
		...
		1 => 'A Felhasználói vezérlőpultban a „Fórum beállítások” menüpont alatt található a „Jelenlét elrejtése” beállítás. Ha ezt <samp>Igen</samp>re állítja, csak az adminisztrátorok, a moderátorok, illetve saját maga fogja látni, hogy jelen van-e.' //? _egy_ beállítás
	),
	array(
	...
	array(
		...
		1 => 'Ezzel elmentheti a még nem befejezett üzenetét, majd később folytathatja, és elküldheti. Egy piszkozat betöltéséhez menjen a felhasználói vezérlőpultra és kövesse a maguktól értetődő lépéseket.' //? magukért beszélő lépések ("self explanatory options")
	),
	array(
	...
	array(
		...
		1 => 'Valószínűleg a keresés túl általános volt, és sok gyakori szót tartalmazhatott, melyeket a phpBB3 nem indexel. Próbáljon meg egy jobban körülhatárolt kifejezést megadni, és használja ki a részletes keresés lehetőségeit.' //? legyél pontosabb/határozotabb stb. (nem juotott eszember rá szó :oops)
	),
	array(
