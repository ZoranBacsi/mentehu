...
if ( $ScrollTop_options['bps_scrolltop'] != 'Off' ) {
	...
	if ( esc_html($_SERVER['REQUEST_METHOD']) == 'POST' && ! isset( $_POST['Submit-SecLog-Search'] ) || @$_GET['settings-updated'] == true ) {
...
<h2 style="margin-left:220px;"><?php _e('BulletProof Security ~ Security Log', 'bulletproof-security'); ?></h2>
...
<div id="bps-modal-content9" title="<?php _e('Security Log', 'bulletproof-security'); ?>">
	...
	<?php
		...
		echo $text;	
	?>
	<strong><a href="http://forum.ait-pro.com/forums/topic/read-me-first-free/#bps-free-general-troubleshooting" title="BPS Troubleshooting Steps" target="_blank"><?php _e('BPS Troubleshooting Steps', 'bulletproof-security'); ?></a></strong><br />
    <strong><a href="http://forum.ait-pro.com/forums/topic/post-request-protection-post-attack-protection-post-request-blocker/" title="POST Request Attack Protection Bonus Custom Code" target="_blank"><?php _e('POST Request Attack Protection', 'bulletproof-security'); ?></a></strong><br /><br />		
...
$search = '';		
	...
	if ( $userAgent != '' && preg_match ( '/[^\/\|\<\>\'\"]/', $userAgent ) ) {		
		...
		echo $bps_topDiv;
		$text = '<font color="red"><strong>'.__('Error: ', 'bulletproof-security').$userAgent.__(' User Agent|Bot was not successfully added. These code characters are not allowed to be used: ', 'bulletproof-security').'/ | < > \' "'.__(' Click the Read Help button for examples of valid User Agent|Bot names.', 'bulletproof-security').'</strong></font>';
		echo $text;
		echo $bps_bottomDiv;		
	}
...
<div id="SecLogPostLimit" style="position:relative;top:0px;left:0px;margin:0px 0px 15px 0px;">
...
echo '<div id="message" class="updated" style="border:1px solid #999999; margin-left:220px;background-color:#ffffe0;"><p>'.$textSecLogRemove.'</p></div>'; 
}
?>
...
<?php 
	...
	if ( isset( $_POST['Submit-SecLog-Search'] ) ) {
		...
		if ( preg_match ( '/[\/\|\<\>\'\"]/', $_POST['userAgentSearchRemove'] ) ) {
			echo $bps_topDiv;
			$text = '<font color="red"><strong>'.__('Error: These code characters are not allowed to be used: ', 'bulletproof-security').'/ | < > \' "'.'</strong></font>';
			echo $text;
			echo $bps_bottomDiv;
		return;	
		}
