...
if(get_option('users_can_register')){
    ...
    <form method="post" action="" id="registerform" name="registerform" class="login-form">
        ...
        <input type="hidden" name="permalink" value="<?php echo esc_attr($loginurl); ?>" />
    ...
    <div class="panel-body" -->
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <div class="input-group input-group-lg">
                        ...
                        <input class="form-control input-lg" required="required" placeholder="<?php _e('Confirm Password','download-manager'); ?>" type="password" size="20" class="required" equalto="#password" id="confirm_user_pass" value="" name="confirm_user_pass">
                    </div>
                </div>
            </div>
        <?php } ?>
        ...
        <?php  if(!isset($params['captcha']) || $params['captcha'] == 'true'){ ?> 
            <div class="form-group row">
                <div class="col-md-12">
                    <?php _e("Verify, you are not a robot:", "download-manager"); ?>
                    <input type="hidden" id="recap" name="recap" value="">
        ...
        <div class="row">
            <div class="col-md-<?php echo ($loginurl != '')?8:12; ?>"><button type="submit" class="btn btn-success btn-lg btn-block" id="registerform-submit" name="wp-submit"><i class="fa fa-user-plus"></i> &nbsp; <?php _e('Join Now!','download-manager'); ?></button></div>
            <?php if($loginurl != ''){ ?>
                <div class="col-md-4"><a href="<?php echo esc_attr($loginurl);?>" class="btn btn-default btn-lg btn-block" id="registerform-submit" name="wp-submit"><i class="fa fa-lock"></i> &nbsp; <?php _e('Login','download-manager'); ?></a></div>
            <?php } ?>
        </div>
