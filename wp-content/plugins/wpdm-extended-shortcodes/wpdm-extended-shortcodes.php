...
if (defined('WPDM_Version')) {
    ...
    function wpdm_tree($params = array())
    {
        ...
        $siteurl = site_url();
        @extract($params);
        $category = isset($category) ? get_term_by("ID", $category, 'wpdmcategory') : null;
...
TREE;
    ...
    function wpdm_extsc_generate()
    {
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?php wpdm_dropdown_categories('c', 0, 'scc1'); ?>
                <button class="btn btn-primary btn-sm" id="crs">Insert to Post</button>
                <script>
            ...
            <div class="panel-body">
                <input type="text" id="pids" placeholder="Package IDs separated by comma"
                       style="width: 250px;display: inline" class="form-control input-sm" value=""/>
