...
$lang = array_merge($lang, array(
	...
	'ADD_FEEDBACK_EXPLAIN'	=> 'Ha hozzá szeretne adni egy feljegyzést, töltse ki az alábbi űrlapot. Csak sima szöveget írjon, HTML, BBCode stb. nem engedélyezett.',
	...
	'FORK_TOPIC_CONFIRM'	=> 'Biztosan meg akarja kettőzni ezt a témát?',
	...
	'MERGE_TOPIC_EXPLAIN'	=> 'Az alábbi űrlap segítségével hozzászólásokat helyezhet át egy másik témába. A hozzászólások nem lesznek újrarendezve, úgy fognak megjelenni, mintha eleve oda küldték volna őket.<br />Adja meg a céltéma azonosítóját, vagy kattintson a „Téma kiválasztása” gombra, hogy megkeresse a témát.',
	...
	'NO_DESTINATION_FORUM'			=> 'Kérjük, válassza ki a célfórumot.',
	...
	'NO_POST'						=> 'Ki kell választania egy hozzászólást, hogy figyelmeztethesse a felhasználót egy hozzászólásáért.',
	'NO_POST_REPORT'				=> 'Ezt a hozzászólást nem jelentették.',
	'NO_POST_SELECTED'				=> 'Legalább egy hozzászólást ki kell választania, hogy elvégezhesse ezt a műveletet.',
	'NO_REASON_DISAPPROVAL'			=> 'Kérjük, adjon meg egy megfelelő okot az elutasításra.',
	...
	'NO_TOPIC_ICON'					=> 'nincs',
	'NO_TOPIC_SELECTED'				=> 'Legalább egy témát ki kell választania, hogy elvégezhesse ezt a műveletet.',
	...
	'REPORT_MESSAGE_EXPLAIN'	=> 'Ennek az űrlapnak a segítségével a kiválasztott privát üzenetet jelentheti. Jelentés csak akkor teendő, ha az üzenet megszegi a fórum szabályait. <strong>A privát üzenet tartalma a jelentéstétel következtében látható lesz a moderátoroknak.</strong>',
	'REPORT_NOTIFY'				=> 'Értesítés',
	'REPORT_NOTIFY_EXPLAIN'		=> 'Kapjon-e ön értesítést, ha a jelentéssel foglalkoztak.',
	...
	'WARNING_PM_BODY'		=> 'Ön a következő figyelmeztetésben részesült egy adminisztrátor vagy egy moderátor által:[quote]%s[/quote]',
	'WARNING_PM_SUBJECT'	=> 'Figyelmeztetés',
	'WARNING_POST_DEFAULT'	=> 'Ön a következő hozzászólása miatt figyelmeztetésben részesültél: %s .',
	'WARNINGS_ZERO_TOTAL'	=> 'Nincs figyelmeztetés.',

	'YOU_SELECTED_TOPIC'	=> 'Ön a %d. számú témát választotta ki: %s',
	...
	'report_reasons'		=> array(
		...
		'DESCRIPTION' => array(
			...
			'OTHER'		=> 'Az üzenet nem tartozik semelyik másik kategóriába, kérjük, töltse ki a további információ mezőt.'
		)
	),
));
