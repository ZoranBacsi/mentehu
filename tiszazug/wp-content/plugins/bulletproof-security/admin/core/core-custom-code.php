...
global $bps_topDiv, $bps_bottomDiv;
	...
	echo $bps_topDiv;
	$text = '<strong><font color="green">'.__('Root Custom Code saved successfully! Go to the Security Modes tab page, click the Create secure.htaccess File AutoMagic button, select the Activate Root Folder BulletProof Mode Radio button and click the Activate|Deactivate button to complete the Root Custom Code setup.', 'bulletproof-security').'</font></strong>';
	echo $text;		
	echo $bps_bottomDiv;	
...
global $bps_topDiv, $bps_bottomDiv;
	...
	echo $bps_topDiv;
	$text = '<strong><font color="green">'.__('wp-admin Custom Code saved successfully! Go to the Security Modes tab page, select the Activate wp-admin Folder BulletProof Mode Radio button and click the Activate|Deactivate button to complete the wp-admin Custom Code setup.', 'bulletproof-security').'</font></strong>';
	echo $text;		
	echo $bps_bottomDiv;	
