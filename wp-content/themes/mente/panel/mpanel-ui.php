			...
			<div class="tiepanel-item"  style=" overflow: visible; ">
				...
				<div class="option-item">
					...
					<div class="home-builder-buttons">
						...
						<a id="add-ads" >ADS</a>
						<a id="add-news-picture" >News in picrure</a>
		...
		<div id="tab12" class="tab_content tabs-wrap">
			...
			<div class="tiepanel-item">
				...
				<?php
					...
					tie_options(
						array(	"name" => "Show Socail Buttons",
								"id" => "archives_socail",
								"type" => "checkbox",
								"help" => "if checked Facebook , Twitter , Google plus and Pinterest socail buttons will appear in all archives pages like categories / tags / search and in homepage blog style ." ));
